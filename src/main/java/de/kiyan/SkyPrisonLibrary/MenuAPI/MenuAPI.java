package de.kiyan.SkyPrisonLibrary.MenuAPI;
...
public class MenuAPI implements Listener
{
    ...
    {
        if( event.getPlayer( ).getOpenInventory( ) == null || event.getPlayer( ).getOpenInventory( ).getTopInventory( ).getHolder( ) instanceof Menu == false )
            return;
