...
public class Titles
{
    ...
    static void sendTimesPacket( Player player, int fadeIn, int stay, int fadeOut )
    {
        try
        {
            ...
            if( oldReflection )
            {
                constructor = getNMSClass( "PacketPlayOutTitle" ).getConstructor( getNMSClass( "EnumTitleAction" ), getNMSClass( "IChatBaseComponent" ), int.class, int.class, int.class );
                enumAction = getNMSClass( "EnumTitleAction" ).getField( "TIMES" ).get( null );
            } else
            {
                constructor = getNMSClass( "PacketPlayOutTitle" ).getConstructor( getNMSClass( "PacketPlayOutTitle" ).getDeclaredClasses( )[ 0 ], getNMSClass( "IChatBaseComponent" ), int.class, int.class, int.class );
    ...
    static void sendTitlePacket( Player player, String JSONTitle )
    {
        try
        {
            ...
            } else
            {
                ...
                title = getNMSClass( "IChatBaseComponent" ).getDeclaredClasses( )[ 0 ].getDeclaredMethod( "a", String.class ).invoke( null, JSONTitle );
            }
    ...
    static void sendSubtitlePacket( Player player, String JSONSubtitle )
    {
        try
        {
            ...
            if( oldReflection )
            {
                ...
                subtitle = getNMSClass( "ChatSerializer" ).getDeclaredMethod( "a", String.class ).invoke( null, JSONSubtitle );
            } else
            {
                constructor = getNMSClass( "PacketPlayOutTitle" ).getConstructor( getNMSClass( "PacketPlayOutTitle" ).getDeclaredClasses( )[ 0 ], getNMSClass( "IChatBaseComponent" ) );

                enumAction = getNMSClass( "PacketPlayOutTitle" ).getDeclaredClasses( )[ 0 ].getField( "SUBTITLE" ).get( null );
                subtitle = getNMSClass( "IChatBaseComponent" ).getDeclaredClasses( )[ 0 ].getDeclaredMethod( "a", String.class ).invoke( null, JSONSubtitle );
            }
    ...
    static void sendActionbarPacket( Player player, String message )
    {
        try
        {
            ...
            } else if( newReflection )
            {
                ...
                Object m = getNMSClass( "IChatBaseComponent" ).getDeclaredClasses( )[ 0 ].getDeclaredMethod( "a", String.class ).invoke( null, message );
