...
public abstract class YesNoGUI extends MenuGUI
{
    ...
    private ItemStack noItem = new ItemBuilder( Material.STAINED_GLASS_PANE ).setName( ChatColor.RED + "" + ChatColor.BOLD + "No" ).setDyeColor( DyeColor.RED ).toItemStack( ), yesItem = new ItemBuilder( Material.STAINED_GLASS_PANE ).setName( ChatColor.GREEN + "" + ChatColor.BOLD + "Yes" ).setDyeColor( DyeColor.GREEN ).toItemStack( );
